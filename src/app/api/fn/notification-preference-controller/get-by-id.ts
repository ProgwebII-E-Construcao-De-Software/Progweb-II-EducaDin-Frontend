...
export function getById(http: HttpClient, rootUrl: string, params: GetById$Params, context?: HttpContext): Observable<StrictHttpResponse<NotificationPreferenceDto>> {
...
getById.PATH = '/1.0/notification-preferences/{id}';
