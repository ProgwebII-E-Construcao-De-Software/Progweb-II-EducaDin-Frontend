...
export function listAll1(http: HttpClient, rootUrl: string, params?: ListAll1$Params, context?: HttpContext): Observable<StrictHttpResponse<Array<GoalListDto>>> {
